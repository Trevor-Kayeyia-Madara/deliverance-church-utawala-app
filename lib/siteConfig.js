export const SITE = {
  ...
  serviceTimes: [
    { day: "Sunday", time: "10:00 AM", label: "Sunday Service" },
  ...
  school: {
    name: "DC Utawala School",
    tagline: "Faith-based learning for the next generation.",
    admissions: {
      phoneDisplay: "+254 700 000 000",
      phoneTel: "+254700000000",
      email: "school@deliveranceutawala.org",
    },
  },
};
